...
import com.dladukedev.common.util.extensions.asLocalDate
import com.dladukedev.common.util.extensions.toMilliseconds
...
data class ThemePickerState(
    val selectedTheme: com.dladukedev.common.models.Theme,
    val onThemeSelected: (com.dladukedev.common.models.Theme) -> Unit,
)

@Stable
sealed class SettingScreenState(
    val requestGoBack: () -> Unit,
...
fun rememberSettingScreenStateHolder(
    ...
    event: SettingsScreenViewModel.Event?,
    goBack: () -> Unit,
    requestGoBack: () -> Unit,
